...
public class Noise3DTextureGenerator : EditorWindow
{
	...
	static private Color PosToColor(Vector3 pos) {
		...
		Vector3 pos2 = pos * 2 + shift * 2;
		Vector3 pos3 = pos * 4 + shift * 4;
		Color color = Color.black;
		color.r = Perlin.Fbm(pos.x, pos.y, pos.z, octave) * 0.5f + 0.5f;
		color.g = Perlin.Fbm(pos2.x + 1.23434567f, 100f - pos2.y + 0.11111f, pos2.z + 91.2344f, octave) * 0.5f + 0.5f;
		color.b = Perlin.Fbm(100f - pos3.x - 17.2793f, pos3.y - 0.77777f, pos3.z + 1237.23233f, octave) * 0.5f + 0.5f;
		color.a = 1f;
		return color;
	}
}
